...
export const GLOSSARY_BY_GENRE = [
  {
    ...
    terms: [
      ...
      {
        word: "ベンチマーク",
        mean: "AI モデルの性能を数値で測るためのテスト。人間の試験のようなもので、モデルを同じ問題で比較できる。ベンチマークにはいくつかの種類があり、何を測るかで結果が大きく異なる。",
      },
      {
        word: "SWE-Bench",
  ...
  },
  {
    ...
    terms: [
      ...
      // ── Git 操作 ──
      {
        ...
        mean: "変更を「確定」して履歴に記録する操作。セーブポイントに近い。コミットメッセージに「なぜ変更したか」を書くのがルール。",
      },
      {
        word: "git push（プッシュ）",
  ...
  },
  {
    ...
    terms: [
      ...
      },
      {
        ...
        mean: "「example.com」のようなドメイン名を IP アドレス（数字の住所）に変換する仕組み。インターネットの電話帳のようなもの。",
      },
      {
        word: "CORS（コース）",
  ...
  },
  {
    ...
    terms: [
      ...
      {
        word: "レビュー",
        mean: "他の開発者がコードの変更内容を確認し、バグや改善点を指摘するプロセス。AI が生成したコードも含め、人間による最終確認が品質を担保する。",
      },
      {
        word: "ステージング",
