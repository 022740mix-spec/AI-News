...
export const ARTICLES_META = [
  ...
  },
  {
    ...
    "type": "news",
    "category": "media",
    "title": "Suno が9月3日からダウンロード制限を導入 — 無料は生涯7回、商用利用は「承認済みダウンロード」が条件に",
    "excerpt": "音楽生成AI **Suno** が2026年9月3日、無料プランは生涯7回、Proプランは月20回、Premierプランは月60回というダウンロード上限を導入したと複数の情報源が伝えている。過去に生成した楽曲も9月3日以降にダウンロードすると制限対象になり、商用利用は承認済みダウンロードを経た楽曲に限られるという。**本記事は公式ヘルプセンターへの直接到達ができておらず、複数の独立した二次情報源による記述に基づく。**",
    "date": "2026-09-03",
    "newsDate": "2026-09-03",
    "author": "AI News 編集部",
    "readTime": "4分",
