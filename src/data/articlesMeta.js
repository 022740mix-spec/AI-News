...
export const ARTICLES_META = [
  ...
  },
  {
    ...
    "type": "feature",
    "category": "regulation",
    "title": "【分析・一次資料未到達】ChatGPT の「__obi」クッキーが外部サイトを横断追跡か — セキュリティ研究者の指摘、OpenAI からの技術的回答はまだ無し",
    "excerpt": "セキュリティ研究者が2026年9月20日前後に公表した分析によれば、ChatGPT が発行する「__obi」というクッキーが、ChatGPT アカウントと外部の広告主サイトでの行動を紐づけて追跡している可能性があるという。ChatGPT を開くとクライアント側で識別子が生成され、アカウントに紐づく短命の署名付きトークンが発行される。このトークンが SameSite=None のクッキーとして保存され、OpenAI の広告計測ピクセルを埋め込んだ外部サイトを訪れた際に送り返される仕組みだと報告されている。研究者は9月14日に OpenAI の press / privacy 窓口へ問い合わせたが、9月20日時点では受領確認のみで技術的な回答は得られていないという。本記事は複数の独立した二次報道が一致する内容を整理したものであり、元となった一次資料（研究者本人のブログ）にはこの実行環境から到達できていない。数値や技術的細部の確度は一次資料での確認を経ておらず、確定情報として扱わない。",
    "date": "2026-09-22",
    "newsDate": "2026-09-20",
    "author": "AI News 編集部",
    "readTime": "6分",
