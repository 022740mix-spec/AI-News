...
export const ARTICLES_META = [
  ...
  },
  {
    ...
    "type": "feature",
    "category": "regulation",
    "title": "【分析】Anthropic対米国防総省、Claude の兵器転用制限を巡る対立 — 連邦判事は「サプライチェーンリスク」指定を違法と判断も、国防総省は控訴の構え",
    "excerpt": "米連邦地裁のリタ・リン判事が、国防総省による Anthropic への「サプライチェーンリスク」指定を**違法**と判断した。背景にあるのは、Anthropic が完全自律型の致死兵器・国内向け大量監視への利用制限の撤廃を拒んだことである。判決後も国防総省側は「控訴中は指定を維持する」との立場を示しており、司法判断と行政の運用が食い違ったまま対立が続いている。",
    "date": "2026-09-18",
    "newsDate": "2026-08-28",
    "author": "AI News 編集部",
    "readTime": "7分",
  ...
  },
  {
    ...
    "type": "feature",
    "category": "special",
    "title": "【分析】Google Assistant が9月4日から終了開始、後継はGemini一択 — 「まず単純な音声コマンドで躓いた」末の1年延期を経ての強制切り替え",
    "excerpt": "Google が Android・Wear OS 上の Google Assistant を2026年9月4日から数週間かけて段階的に終了し、後継は Gemini のみになる。切り替わったユーザーは旧 Assistant に戻れない。移行は当初2025年内の予定だったが、Gemini がタイマー設定のような単純な機器操作コマンドでつまずいたことを理由に1年延期されたと報じられている。10年運用された確定的な音声アシスタントを、確率的なLLMベースのアシスタントへ選択肢なしで置き換える、規模としては最大級の強制移行である。",
    "date": "2026-09-18",
    "newsDate": "2026-09-04",
    "author": "AI News 編集部",
    "readTime": "6分",
