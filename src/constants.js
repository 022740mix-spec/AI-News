...
export const MODEL_COMPARISON = [
  ...
  { name: "Gemini 3.1 Pro", rating: 4.0, summary: "Google フラッグシップ。2Mコンテキストは業界最大。長大なコードベースの一括読み込みに強い。SWE-bench Verified 80.6%。$1.25/$5", swe: 80.6, aime: null, arc: 77, hle: null, mmmu: 81 },
