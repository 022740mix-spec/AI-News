...
export const MODEL_COMPARISON = [
  ...
  // 最終更新: 2026-07-13（GPT-5.6 3種類 GA・Grok 4.5 公開・LongCat-2.0/GLM-5.2/Muse Spark 1.1 追加）
  ...
  // === OpenAI ===
  { name: "GPT-5.6 Sol", rating: 5.0, summary: "OpenAI 最新フラッグシップ（7/9 GA、6/25 限定プレビューから ChatGPT/API/Codex 一般公開）。1.5M ctx、最難関タスク向け。Ultra mode はサブエージェント活用、TerminalBench 2.1 で 91.91% SOTA（Mythos 5・Fable 5 超え）。Cerebras 上で最大 750 tokens/秒。ChatGPT Work の駆動モデル。$5/$30 per 1M tokens", swe: null, aime: null, arc: null, hle: null, mmmu: null },
  ...
  // === xAI ===
  { name: "Grok 4.5", rating: 4.5, summary: "xAI（SpaceX 傘下）最新フラッグシップ（7/9 GA）。1.5T V9 基盤 + Cursor 訓練データ、Musk「Opus クラスだが faster・token-efficient・低コスト」と主張。「タスクを半分のステップで完了」。$2/$6 per 1M tokens で GPT-5.6 Terra（$2.50/$15）を下回るフロンティア級最安。SuperGrok Heavy $300/月経由", swe: null, aime: null, arc: null, hle: null, mmmu: null },
  ...
  // === China ===
  { name: "LongCat-2.0", rating: 4.5, summary: "Meituan（美団）新フラッグシップ（6/30 OSS 公開）。**1.6T MoE**（アクティブ 33B-56B）、1M ctx、MIT ライセンス。**50,000枚の中国国産 AI ASIC** で訓練（NVIDIA GPU 不使用）— この規模で初の完全国産チップ訓練モデル。SWE-bench Pro 59.5 で GPT-5.5（58.6）超え、Opus 4.6 と同水準。米国 API シェア 46% 拡大の牽引役", swe: 59.5, aime: null, arc: null, hle: null, mmmu: null },
  ...
  { name: "GLM-5.2", rating: 4.5, summary: "Z.ai（清華大学発 Zhipu AI）新フラッグシップ（6/13）。**753B MoE（アクティブ 40B）**、1M ctx、MIT ライセンス。High/Max デュアル思考、IndexShare 長文脈最適化。**SWE-bench Pro 62.1** で GPT-5.5（58.6）超え・Opus 4.8（69.2）に肉薄、FrontierSWE 74.4。Hugging Face で MIT 重み公開", swe: 62.1, aime: null, arc: null, hle: null, mmmu: null },
