...
export const MODEL_COMPARISON = [
  ...
  { name: "Claude Opus 5.5", rating: 5, summary: "Anthropic 現行の既定モデル（2026年9月22日公開）。公式ドキュメントが「ほとんどのワークロードではここから始めよ」とし、Opus 5 は legacy へ移った。$4/$20 で Opus 5（$5/$25）から20%減、キャッシュ読み取りは基本入力の0.05倍（$0.20）。1M コンテキスト、最大出力128K、知識カットオフ2026年6月。思考は常時オンで無効化できず、既定 effort は medium（Opus 5 は high）。ただし同じ effort では Opus 5 より多く思考すると公式が明記しており、単価差がそのまま実効コスト差にはならない。破壊的変更が4つある。公式ドキュメントにベンチマーク値の掲載が無いため列はすべて null", swe: null, swePro: null, terminalBench: null, osworld: null, browseComp: null, gpqa: null, aime: null, hle: null },
