...
export const MODEL_COMPARISON = [
  ...
  { name: "GPT-5.6 Terra", rating: 4.5, summary: "OpenAI daily driver（7/9 GA）。1.5M ctx、大量業務向け（カスタマーサポート・社内ツール・文書解析）。$2.50/$15（GPT-5.5 比半額）。Sonnet 5 と直接競合", swe: null, swePro: null, terminalBench: null, osworld: null, browseComp: null, gpqa: null, aime: null, hle: null },
  { name: "GPT-5.6 Luna", rating: 4.0, summary: "OpenAI 軽量タスク向け（7/9 GA）。1.5M ctx、要約・ドラフト・定型自動化。$1/$6 でフロンティア最安級。中国 OSS 対抗軸", swe: null, swePro: null, terminalBench: null, osworld: null, browseComp: null, gpqa: null, aime: null, hle: null },
  ...
  // === China ===
  { name: "LongCat-2.0", rating: 4.5, summary: "Meituan（美団）新フラッグシップ（6/30 OSS 公開）。1.6T MoE（アクティブ 33B-56B）、1M ctx、MIT。50,000枚の中国国産 AI ASIC で訓練（NVIDIA GPU 不使用）— この規模で初の完全国産チップ訓練モデル。SWE-Pro 59.5% で GPT-5.5 超え。米国 API シェア 46% 拡大の牽引役", swe: null, swePro: 59.5, terminalBench: null, osworld: null, browseComp: null, gpqa: null, aime: null, hle: null },
  ...
  { name: "GLM-5.2", rating: 4.5, summary: "Z.ai（清華大学発 Zhipu AI）新フラッグシップ（6/13）。753B MoE（アクティブ 40B）、1M ctx、MIT。SWE-Pro 62.1% で GPT-5.5 超え・Opus 4.8 に肉薄、FrontierSWE 74.4%。Hugging Face で MIT 重み公開", swe: null, swePro: 62.1, terminalBench: null, osworld: null, browseComp: null, gpqa: null, aime: null, hle: null },
